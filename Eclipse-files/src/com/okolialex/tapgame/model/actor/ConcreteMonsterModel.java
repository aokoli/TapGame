 ...
 *
 */
// TODO As part of constructor, add initial location
/**
 * This class represents the monster that travels randomly across
 * the playable game grid area. 
 * 
 ...
 *
 */
public class ConcreteMonsterModel extends MonsterModel {
	 ...
	 */
	public ConcreteMonsterModel(WorldModel worldModel){
	 ...
	 */
	public ConcreteMonsterModel (WorldModel worldModel, int initialX, int initialY) {
		this.mWorldModel = worldModel;
