...
public abstract class MonsterModel extends AsyncTask<Void, Void, Void> {
	...
	/** Sets the monster world (so monster can 'see' where its going) */
	public abstract void setWorld (WorldModel worldModel);
