...
/**
 * A GUI-level test for several TapGame scenarios. 
 * 
...
// TODO All unit tests! testGetMonsterLocation(), testGetY() etc.
/*
 * TODO Model acts randomly. Monitor random functions
 * 1. Make sure we can control monster in UI from test
 * 2. Engineer AutoEngine constructor to use seed. 
 */
public class TapGameControllerActivityTest extends ActivityInstrumentationTestCase2<ModifiedTapGameController> {
	...
	protected void setUp() throws Exception {
	    super.setUp();
	    // setActivityInitialTouchMode(false); // TODO Point?
	...
	// TODO Spell out scenarios explicitly!
	...
	/** 
	  *	Verifies that the engine used to manage the random monster movement/state change 
	  * is functioning accurately.
	  */
	public void testRandomEngine() { // TODO Implement
	
	}
	
	public void testTimeCountDown() { // TODO Implement. 
	...
	/** 
	 * The real monster (ConcreteMonsterModel) uses a random algorithm for
	 ...
	 */
	private class MockMonster extends ConcreteMonsterModel {
		...
		/** The random algorithm is controlled i.e. Using a particular seed, we know the outcome of
		 * the random generator. We then make tests based on those predicted outcomes. */
		@Override
