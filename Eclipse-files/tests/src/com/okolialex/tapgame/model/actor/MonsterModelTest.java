...
public class MonsterModelTest extends TestCase {

	protected MonsterModel monster;
	protected void setMonsterModel(final MonsterModel monster) {
	...
	protected void generateNewMonster() {
		setMonsterModel(new ConcreteMonsterModel());
		setWorldModel(new ConcreteWorldModel());
		monster.setWorld(world); // <-- Only needed for changeMonsterState(), in this test class.
	}
